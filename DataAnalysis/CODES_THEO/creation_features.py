...
#choix_pilote = 5
###### VOIR CODE CREATION BASEMOOV POUR LE CHOIX PILOTE
...
#   BUG
filename = address_folder + pilot_names[choix_pilote] + "/numData_100ms_.csv"

# faire gaffe a .csv present ou non

#filename = address_folder + pilot_names[choix_pilote] + "/numData_10ms_.csv"
...
dataFlight = dataFlight.drop_duplicates(subset = "FD_PILOT_HEAD_PITCH" )
